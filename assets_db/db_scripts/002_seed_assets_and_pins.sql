...
set label = excluded.label,
    ...
    x_px = excluded.x_px,
    y_px = excluded.y_px,
    x_3d = coalesce(excluded.x_3d, circuit_component_pins.x_3d),
    y_3d = coalesce(excluded.y_3d, circuit_component_pins.y_3d),
    z_3d = coalesce(excluded.z_3d, circuit_component_pins.z_3d),
    model_anchor_name = coalesce(excluded.model_anchor_name, circuit_component_pins.model_anchor_name),
