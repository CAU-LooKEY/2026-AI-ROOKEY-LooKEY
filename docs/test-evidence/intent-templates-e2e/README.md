...
browser UI, opens the 3D circuit page, waits for all five rendered parts including
the generated breadboard, verifies the WebGL canvas and jumper-wire count, and
writes one full-page screenshot per demo into this directory.
